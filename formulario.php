 ...
 */
$store = array("amount" => ($_POST["txtMonto"] * 100), 
"currency" => "PEN", 
...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/000webhost/app-izipay/style/classic-reset.css">
  <script src="http://localhost/000webhost/app-izipay/js/classic.js"></script>
  <!-- <link rel="stylesheet" 
   href="<?php echo $client->getClientEndpoint();?>/static/js/krypton-client/V4.0/ext/classic-reset.css"> -->
   <!-- <link rel="stylesheet" 
   href="<?php echo $client->getClientEndpoint();?>/static/js/krypton-client/V4.0/ext/no-theme.css"> -->
  <!-- <script 
